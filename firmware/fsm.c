...
void fsm_msgGetFeatures(GetFeatures *msg)
{
	(void)msg;
	RESP_INIT(Features);
	resp->has_vendor = true;         strlcpy(resp->vendor, "safe-t.io", sizeof(resp->vendor));
...
#if CRYPTOMEM
	resp->has_pin_remaining_zones = true; resp->pin_remaining_zones = storage_remaining_zones();
#endif
